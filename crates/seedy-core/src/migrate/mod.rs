//! Best-effort migration from other tools' configs to `seedy.yaml`.
//!
//! Neither source tool has a format that maps onto seedy 1:1. Snaplet
...
pub enum ConversionConfidence {
    /// A direct, faithful equivalent exists in seedy.
    Exact,
    /// The closest available seedy strategy, but not a perfect match —
